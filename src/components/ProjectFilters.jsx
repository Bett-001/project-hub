...
export function ProjectFilters({ filters, onFilterChange }) {
    ...
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      <div className="relative flex-1">
        ...
        <Input
          ...
          onChange={(e) => onFilterChange({ ...filters, search)}
          className="pl-9"
        />
      </div>
      ...
      <Select
        ...
        onValueChange={(value) => onFilterChange({ ...filters, cohort === 'all' ? '' )}
      >
      ...
      <Select
        ...
        onValueChange={(value) => onFilterChange({ ...filters, techStack === 'all' ? '' )}
      >
        <SelectTrigger className="w-full sm:w-[160px] bg-card">
