...
import { FilterOptions, Project, TechStack, User } from '@/types';
...
export default function Dashboard() {
  ...
  const [filters, setFilters] = useState<FilterOptions>({ cohort: '', techStack: '', search: '' });
  ...
  const filteredProjects = useMemo(() => {
    return mockProjects.filter((project) => {
      ...
      const matchesTech = !filters.techStack || project.techStack.includes(filters.techStack as TechStack);
